...
Partial Public Class dbcensosDataSet
    ...
    Private relationusuarios_rol As Global.System.Data.DataRelation
    ...
    Friend Overloads Sub InitVars(ByVal initTable As Boolean)
        ...
        If (initTable = true) Then
            ...
            End If
        End If
        Me.relationusuarios_rol = Me.Relations("usuarios_rol")
    End Sub
    ...
    Private Sub InitClass()
        ...
        Me.relationusuarios_rol = New Global.System.Data.DataRelation("usuarios_rol", New Global.System.Data.DataColumn() {Me.tableusuarios.idrolColumn}, New Global.System.Data.DataColumn() {Me.tablerol.idrolColumn}, false)
        Me.Relations.Add(Me.relationusuarios_rol)
    End Sub
    ...
    Partial Public Class rolDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddrolRow(ByVal rol As String) As rolRow
            Dim rowrolRow As rolRow = CType(Me.NewRow,rolRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, rol}
    ...
    Partial Public Class usuariosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddusuariosRow(ByVal nombre As String, ByVal password As String, ByVal idrol As Integer, ByVal activo As Boolean) As usuariosRow
            Dim rowusuariosRow As usuariosRow = CType(Me.NewRow,usuariosRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, nombre, password, idrol, activo}
    ...
    Partial Public Class rolRow
        ...
        Public Property usuariosRow() As usuariosRow
            Get
                Return CType(Me.GetParentRow(Me.Table.ParentRelations("usuarios_rol")),usuariosRow)
            End Get
            Set
                Me.SetParentRow(value, Me.Table.ParentRelations("usuarios_rol"))
            End Set
        End Property
        ...
        Public Function IsrolNull() As Boolean
            Return Me.IsNull(Me.tablerol.rolColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetrolNull()
            Me(Me.tablerol.rolColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class usuariosRow
        ...
        Public Property idrol() As Integer
            Get
                Return CType(Me(Me.tableusuarios.idrolColumn),Integer)
            End Get
            Set
                Me(Me.tableusuarios.idrolColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function GetrolRows() As rolRow()
            If (Me.Table.ChildRelations("usuarios_rol") Is Nothing) Then
                Return New rolRow(-1) {}
            Else
                Return CType(MyBase.GetChildRows(Me.Table.ChildRelations("usuarios_rol")),rolRow())
            End If
        End Function
    End Class
...
Namespace dbcensosDataSetTableAdapters
    ...
    Partial Public Class rolTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `rol` WHERE ((`idrol` = @p1) AND ((@p2 = 1 AND `rol` IS NULL) OR (`ro"& _ 
                "l` = @p3)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `rol` (`rol`) VALUES (@p1)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `rol` SET `rol` = @p1 WHERE ((`idrol` = @p2) AND ((@p3 = 1 AND `rol` IS NU"& _ 
                "LL) OR (`rol` = @p4)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT `idrol`, `rol` FROM `rol`"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.MySql.Data.MySqlClient.MySqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT `idrol`, `rol` FROM `rol`"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE (idrol=?)"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As dbcensosDataSet.rolDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As dbcensosDataSet.rolDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As dbcensosDataSet.rolDataTable = New dbcensosDataSet.rolDataTable()
        ...
        Public Overloads Overridable Function FillByIdRol(ByVal dataTable As dbcensosDataSet.rolDataTable, ByVal Param1 As Integer) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal Param1 As Integer) As dbcensosDataSet.rolDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(Param1,Integer)
            Dim dataTable As dbcensosDataSet.rolDataTable = New dbcensosDataSet.rolDataTable()
            Me.Adapter.Fill(dataTable)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As dbcensosDataSet.rolDataTable) As Integer
    ...
    Partial Public Class usuariosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.MySql.Data.MySqlClient.MySqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT idusuarios, nombre, password, usuarios.idrol, activo, rol.rol "&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM usua"& _ 
                "rios INNER JOIN  rol"&Global.Microsoft.VisualBasic.ChrW(10)&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE (usuarios.idrol=rol.idrol); "
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.MySql.Data.MySqlClient.MySqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT idusuarios, nombre, password, usuarios.idrol, activo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM usuarios "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHER"& _ 
                "E (usuarios.nombre=@p1) AND (usuarios.password=@p2)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter()
            param.ParameterName = "@p1"
            param.DbType = Global.System.Data.DbType.[String]
            ...
            Me._commandCollection(2).CommandText = "UPDATE usuarios"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SET activo=1"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE (idusuarios=@p1)"
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As dbcensosDataSet.usuariosDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As dbcensosDataSet.usuariosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As dbcensosDataSet.usuariosDataTable = New dbcensosDataSet.usuariosDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy(ByVal dataTable As dbcensosDataSet.usuariosDataTable, ByVal p1 As String, ByVal p2 As String) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (p1 Is Nothing) Then
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(1).Value = CType(p2,String)
            End If
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy(ByVal p1 As String, ByVal p2 As String) As dbcensosDataSet.usuariosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (p1 Is Nothing) Then
                Throw New Global.System.ArgumentNullException("p1")
            Else
        ...
        Public Overloads Overridable Function UpdateUserActivo(ByVal p1 As Integer) As Integer
        ...
        Public Overridable Function UpdateAll(ByVal dataSet As dbcensosDataSet) As Integer
            ...
            Try 
                ...
                If (Not (Me._rolTableAdapter) Is Nothing) Then
                    ...
                    Me._rolTableAdapter.Connection = CType(workConnection,Global.MySql.Data.MySqlClient.MySqlConnection)
                    Me._rolTableAdapter.Transaction = CType(workTransaction,Global.MySql.Data.MySqlClient.MySqlTransaction)
            ...
            Finally
                ...
                End If
                If (Not (Me._rolTableAdapter) Is Nothing) Then
                    Me._rolTableAdapter.Connection = CType(revertConnections(Me._rolTableAdapter),Global.MySql.Data.MySqlClient.MySqlConnection)
