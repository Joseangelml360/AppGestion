Public Class FrmSubDatosCuotas
    Private Sub FrmSubDatosCuotas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim nCod As Integer
        nCod = Val(FALLERO_CODIGOTextBox.Text)
    ...
    Private Sub BtnActualizar_Click(sender As Object, e As EventArgs) Handles BtnActualizar.Click
        ...
        'Guardar cuenta IBAN sin espacios
        Try
    ...
    Private Sub BENEFICIOSTextBox_TextChanged(sender As Object, e As EventArgs) Handles BENEFICIOSTextBox.TextChanged
