Public Class FrmAñadirHistorial
    Private Sub FrmAñadirHistorial_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            If Val(Me.TxtCargo.Text) > 22 Or Val(Me.TxtCargo.Text) < 1 Then
        ...
        Try
            HistorfaTableAdapter.InsertHistorico(nCod, nAnoCen, nFalla, cDNI, nCargo, nRecJCF, nTipFal,
                                                             nCodFalla, nRecFal, nRecAgrup, cObserv)
            MsgBox("Guardado")
